              ...
              <div className="flex flex-col space-y-5">
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[3].stage22_date}</div>
                    <div className="text-gray-200">{data[3].stage22_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[3].stage22_post}</div>
                    <div>{data[3].stage22_description}</div>
                  </div>
                </div>
                <span className="text-yellow-400">Profil: </span>
                <div>{data[3].stage22_description1}</div>
                <span className="text-yellow-400">Lucrare: </span>
                <div>{data[3].stage22_description2}</div>
              </div>
            </Transition>
          </Disclosure.Panel>
        </>
