              ...
              <div className="flex flex-col space-y-10">
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[2].stage11_date}</div>
                    <div className="text-gray-200">{data[2].stage11_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[2].stage11_post}</div>
                    <div>{data[2].stage11_description}</div>
                  </div>
                </div>
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[2].stage12_date}</div>
                    <div className="text-gray-200">{data[2].stage12_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[2].stage12_post}</div>
                    <div>{data[2].stage12_description}</div>
                  </div>
                </div>
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[2].stage13_date}</div>
                    <div className="text-gray-200">{data[2].stage13_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[2].stage13_post}</div>
                    <div>{data[2].stage13_description}</div>
                  </div>
                </div>
              </div>
            </Transition>
