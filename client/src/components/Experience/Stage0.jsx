              ...
              <div className="flex flex-col space-y-10">
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[1].stage01_date}</div>
                    <div className="text-gray-200">{data[1].stage01_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[1].stage01_post}</div>
                    <div>{data[1].stage01_description}</div>
                  </div>
                </div>
                <div className="flex flex-row justify-between">
                  <div className="flex flex-col space-y-2 w-1/3">
                    <div className="text-cyan-400">{data[1].stage02_date}</div>
                    <div className="text-gray-200">{data[1].stage02_place}</div>
                  </div>
                  <div className="flex flex-col space-y-2 w-2/3">
                    <div className="text-teal-400">{data[1].stage02_post}</div>
                    <div>{data[1].stage02_description}</div>
                  </div>
                </div>
              </div>
            </Transition>
